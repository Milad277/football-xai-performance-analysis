-- Final feature extraction query for the football XAI performance analysis project.
-- This query creates match-level home/away tactical features from the SQLite database.
WITH
team_sides AS (
    SELECT 
        mt.matchId,
...
event_points AS (
    SELECT
        ...
        e.matchId,
        e.teamId,
        LOWER(TRIM(e.period))        AS period_str,          
